...
Deno.serve(async (req) => {
  try {
    ...
    // --- COZINHA submetida ---
    if (
      changedFields.includes("scale_submitted") &&
      data.scale_submitted === true &&
      oldData?.scale_submitted !== true
    ) {
      notifications.push({
    ...
    // --- SALÃO submetido ---
    if (
      changedFields.includes("salao_submitted") &&
      data.salao_submitted === true &&
      oldData?.salao_submitted !== true
    ) {
      notifications.push({
    ...
    // --- COZINHA aprovada ---
    if (
      changedFields.includes("scale_approved") &&
      data.scale_approved === true &&
      oldData?.scale_approved !== true
    ) {
      notifications.push({
    ...
    // --- COZINHA reprovada ---
    if (
      changedFields.includes("scale_rejected") &&
      data.scale_rejected === true &&
      oldData?.scale_rejected !== true
    ) {
      notifications.push({
    ...
    // --- SALÃO aprovado ---
    if (
      changedFields.includes("salao_approved") &&
      data.salao_approved === true &&
      oldData?.salao_approved !== true
    ) {
      notifications.push({
    ...
    // --- SALÃO reprovado ---
    if (
      changedFields.includes("salao_rejected") &&
      data.salao_rejected === true &&
      oldData?.salao_rejected !== true
    ) {
      notifications.push({
