...
export default function Layout() {
  ...
  return (
    <div className="flex flex-col bg-background" style={{ height: '100dvh', paddingTop: "env(safe-area-inset-top)", overflow: 'hidden' }}>
      {/* Header */}
      ...
      {/* Main content */}
      <main className="flex-1 w-full px-4 sm:px-6 lg:px-8 py-4 sm:py-6 pb-8 overflow-x-hidden overflow-y-auto">
